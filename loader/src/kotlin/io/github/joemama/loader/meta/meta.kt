...
data class Transform(val name: String, val target: String, val clazz: String) {
    companion object {
        fun deserialize(t: TomlTable): Transform {
            ...
            val target =
                t.getString("target") ?: throw MetaParseException("Must provide a 'target' field for transforms")
...
data class ModMeta(
    ...
    companion object {
        fun deserialize(t: TomlTable): ModMeta {
            ...
            val version: String =
                t.getString("version") ?: throw MetaParseException("Must provide a 'version' field for a mod")
            val description: String =
                t.getString("description") ?: throw MetaParseException("Must provide a 'description' field for a mod")
            val id: String =
                t.getString("modid") ?: throw MetaParseException("Every mod must have a unique 'modid' field")
